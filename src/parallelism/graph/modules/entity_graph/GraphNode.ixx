...
inline void GraphNode::DependsOn(GraphNode& other) {
...
inline bool GraphNode::Root() {

	return root;

}

inline void GraphNode::Root(bool other) {

	root = other;

}

inline void GraphNode::AddChild(GraphNode* child) {
